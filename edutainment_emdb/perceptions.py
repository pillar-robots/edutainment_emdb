    ...
    def process_and_send_reading(self):
        ...
        if isinstance(self.reading, list):
            ...
            for perception in self.reading:
                ...
                data = np.array([teacher_present_perception, teacher_type_perception, student_type_perception, challenge_completion_perception, python_error_streak_perception, evaluation_error_streak_perception, bored_perception, standing_perception])
                labels = ["teacher_present_perception", "teacher_type_perception", "student_type_perception", "challenge_completion_perception", "python_error_streak_perception", "evaluation_error_streak_perception", "bored_perception", "standing_perception"]
        else:
